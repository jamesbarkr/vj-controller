...
import { AnimationSpecs, animationSpecsToData, interpolateAnimationDataAtTime } from '../../utils/animation';
...
const animationSpecs: AnimationSpecs = {
    states: {
        ...
        [RotationAnimationState.BACK]: [-Math.PI / 2, Math.PI / 4, -Math.PI, 40, 0, -20],
        [RotationAnimationState.FORWARD]: [Math.PI / 2, -Math.PI / 4, Math.PI, -30, 0, -20]
    },
